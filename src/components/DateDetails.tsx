  ...
  return (
    <div className="w-full space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Date & Time */}
        <div className="bg-white/90 rounded-2xl p-4 sm:p-5 border-3 border-[#FF4D6D] shadow-lg flex items-start gap-3.5">
          <div className="p-3 rounded-2xl bg-[#FFB3C1]/50 text-[#FF4D6D] shrink-0 border border-[#FF758F]">
            <Calendar className="w-6 h-6" />
          </div>
          <div>
            <div className="text-[11px] font-black uppercase text-[#800F2F] tracking-wider">Когда</div>
          ...
          <div className="min-w-0 flex-1">
            ...
            {invitation.locationMapUrl && (
              <a
                ...
                className="inline-block text-xs font-black text-[#FF4D6D] hover:underline mt-1.5"
              >
                Открыть на карте 🗺️
              </a>
            )}
      ...
      {/* Comment Box */}
      <div className="bg-white/90 rounded-[28px] p-5 sm:p-6 border-3 border-[#FF4D6D] shadow-lg flex flex-col">
        <div className="flex items-center gap-2.5 mb-3">
          <MessageSquare className="w-5 h-5 text-[#FF4D6D]" />
          <h4 className="text-xs font-black uppercase tracking-wider text-[#590D22]">Особые пожелания?</h4>
        </div>
        <textarea
